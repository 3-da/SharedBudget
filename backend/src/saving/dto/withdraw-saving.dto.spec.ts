...
import { WithdrawSavingDto } from './withdraw-saving.dto';

describe('WithdrawSavingDto', () => {
    const validData = { amount: 50.0 };

    it('should accept valid data with only required fields', async () => {
        const dto = plainToInstance(WithdrawSavingDto, validData);
    ...
    it('should accept valid data with all fields', async () => {
        const dto = plainToInstance(WithdrawSavingDto, { amount: 100.5, month: 6, year: 2026 });
        const errors = await validate(dto);
    ...
    describe('amount', () => {
        it('should accept amount at minimum (boundary: 0.01)', async () => {
            const dto = plainToInstance(WithdrawSavingDto, { amount: 0.01 });
            const errors = await validate(dto);
        ...
        it('should reject amount below minimum (boundary: 0)', async () => {
            const dto = plainToInstance(WithdrawSavingDto, { amount: 0 });
            const errors = await validate(dto);
        ...
        it('should reject negative amount', async () => {
            const dto = plainToInstance(WithdrawSavingDto, { amount: -5 });
            const errors = await validate(dto);
        ...
        it('should reject non-number amount', async () => {
            const dto = plainToInstance(WithdrawSavingDto, { amount: 'abc' });
            const errors = await validate(dto);
        ...
        it('should reject missing amount', async () => {
            const dto = plainToInstance(WithdrawSavingDto, {});
            const errors = await validate(dto);
        ...
        it('should reject a sub-cent amount (more than 2 decimal places)', async () => {
            const dto = plainToInstance(WithdrawSavingDto, { amount: 50.005 });
            const errors = await validate(dto);
        ...
        it('should accept an amount with exactly 2 decimal places', async () => {
            const dto = plainToInstance(WithdrawSavingDto, { amount: 50.0 });
            const errors = await validate(dto);
        ...
        it('should accept an amount with a single decimal place', async () => {
            const dto = plainToInstance(WithdrawSavingDto, { amount: 50.1 });
            const errors = await validate(dto);
    ...
    describe('month', () => {
        it('should accept month at minimum (boundary: 1)', async () => {
            const dto = plainToInstance(WithdrawSavingDto, { ...validData, month: 1 });
            const errors = await validate(dto);
        ...
        it('should reject month below minimum (boundary: 0)', async () => {
            const dto = plainToInstance(WithdrawSavingDto, { ...validData, month: 0 });
            const errors = await validate(dto);
        ...
        it('should accept month at maximum (boundary: 12)', async () => {
            const dto = plainToInstance(WithdrawSavingDto, { ...validData, month: 12 });
            const errors = await validate(dto);
        ...
        it('should reject month above maximum (boundary: 13)', async () => {
            const dto = plainToInstance(WithdrawSavingDto, { ...validData, month: 13 });
            const errors = await validate(dto);
        ...
        it('should reject non-integer month', async () => {
            const dto = plainToInstance(WithdrawSavingDto, { ...validData, month: 6.5 });
            const errors = await validate(dto);
        ...
        it('should accept missing month (optional)', async () => {
            const dto = plainToInstance(WithdrawSavingDto, { amount: 50 });
            const errors = await validate(dto);
    ...
    describe('year', () => {
        it('should accept year at minimum (boundary: 2020)', async () => {
            const dto = plainToInstance(WithdrawSavingDto, { ...validData, year: 2020 });
            const errors = await validate(dto);
        ...
        it('should reject year below minimum (boundary: 2019)', async () => {
            const dto = plainToInstance(WithdrawSavingDto, { ...validData, year: 2019 });
            const errors = await validate(dto);
        ...
        it('should accept year at maximum (boundary: 2099)', async () => {
            const dto = plainToInstance(WithdrawSavingDto, { ...validData, year: 2099 });
            const errors = await validate(dto);
        ...
        it('should reject year above maximum (boundary: 2100)', async () => {
            const dto = plainToInstance(WithdrawSavingDto, { ...validData, year: 2100 });
            const errors = await validate(dto);
        ...
        it('should reject non-integer year', async () => {
            const dto = plainToInstance(WithdrawSavingDto, { ...validData, year: 2026.5 });
            const errors = await validate(dto);
